...
void BleGamepad::begin(uint16_t buttonCount, uint8_t hatSwitchCount, bool includeXAxis, bool includeYAxis, bool includeZAxis, bool includeRzAxis, bool includeRxAxis, bool includeRyAxis, bool includeSlider1, bool includeSlider2, bool includeRudder, bool includeThrottle, bool includeAccelerator, bool includeBrake, bool includeSteering)
{
	...
	uint8_t numOfControlBytes = 1;
	
	reportSize = numOfButtonBytes + numOfControlBytes + numOfAxisBytes + numOfSimulationBytes + _hatSwitchCount;
	...
	//       start and select
	{
		...
		// REPORT_COUNT (# of buttons)
		tempHidReportDescriptor[hidReportDescriptorSize++] = 0x95;
		tempHidReportDescriptor[hidReportDescriptorSize++] = 3;
		...
		// USAGE (System Context Menu)
		tempHidReportDescriptor[hidReportDescriptorSize++] = 0x09;
		tempHidReportDescriptor[hidReportDescriptorSize++] = 0x86;   //0x84 didn't work
		...
		// REPORT_COUNT (# of padding bits)
		tempHidReportDescriptor[hidReportDescriptorSize++] = 0x95;
		tempHidReportDescriptor[hidReportDescriptorSize++] = 8-3;
...
void BleGamepad::sendReport(void)
{
	if (this->isConnected())
	{
		...
		m[currentReportIndex++] = (_start?1:0) | (_select?2:0) | (_mode?4:0);
...
void BleGamepad::setStart(bool isPressed)
{
	_start = isPressed;
...
void BleGamepad::setSelect(bool isPressed)
{
	_select = isPressed;
...
void BleGamepad::setMode(bool isPressed)
{
	_mode = isPressed;
