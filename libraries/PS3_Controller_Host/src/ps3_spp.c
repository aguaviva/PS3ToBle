...
*/
    ...
    ESP_LOGI(PS3_TAG, "esp_bt_controller_init...");
    esp_bt_controller_config_t bt_cfg = BT_CONTROLLER_INIT_CONFIG_DEFAULT();
    ...
    ESP_LOGI(PS3_TAG, "esp_bt_controller_enable...");
    ...
    ESP_LOGI(PS3_TAG, "esp_bluedroid_init...");
    ...
    ESP_LOGI(PS3_TAG, "esp_bluedroid_enable...");
    ...
    ESP_LOGI(PS3_TAG, "esp_spp_register_callback...");
    if ((err = esp_spp_register_callback(ps3_spp_callback)) != ESP_OK) {
        ESP_LOGE(PS3_TAG, "%s spp register failed: %s\n", __func__, esp_err_to_name(err));
        return false;
    }
    ESP_LOGI(PS3_TAG, "OK");
    
    ESP_LOGI(PS3_TAG, "esp_spp_init...");
